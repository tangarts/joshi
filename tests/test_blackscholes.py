...
class TestVanillaBlackScholes(unittest.TestCase):
    ...
    def test_put_call(self):
        ...
        """
        call = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
        put = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0.01, T=1, opt_type='put', exer_type='european')
        self.assertAlmostEqual(call.vanilla_price() - put.vanilla_price(), call.forward() - call.K*call.bond())
    ...
    def test_monotone_decreasing_call_with_strike(self):
        ...
        """
        strike120 = BlackScholes(spot0=100, K=120, sigma=0.3, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
        strike100 = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
        strike90 = BlackScholes(spot0=100, K=90, sigma=0.3, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
    ...
    def call_option_bounded(self):
        """
        (iii) a call option should be between S and S - Kexp(-rT)
        """
        option = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
        
        self.assertGreater( option.vanilla_price(), option.spot0 - option.K*option.bond() )
    ...
    def test_monotone_increasing_call_in_volatility(self):
        ...
        """
        vol_20 = BlackScholes(spot0=100, K=100, sigma=0.2, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
        vol_30 = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
        vol_50 = BlackScholes(spot0=100, K=100, sigma=0.5, \
                r=0.05, delta=0.01, T=1, opt_type='call', exer_type='european')
    ...
    def test_increase_with_t(self):
        ...
        """
        t_100 = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0., T=1, opt_type='call', exer_type='european')
        t_50 = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0., T=0.5, opt_type='call', exer_type='european')
        t_30 = BlackScholes(spot0=100, K=100, sigma=0.3, \
                r=0.05, delta=0., T=.3, opt_type='call', exer_type='european')
